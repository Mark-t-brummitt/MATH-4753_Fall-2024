#' @title My Bootstrap P-Value Function
#'
#' @param x,conf.level,iter,mu,test the dataset, the confidence level, iterations, the mean, and the style of test.
#'
#' @importFrom stats sd
#' @importFrom graphics title
#' @return Several vectors and a histogram.
#'
#' @export
#'
#' @examples
